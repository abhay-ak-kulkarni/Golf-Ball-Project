...
\hypersetup{unicode=true,
            pdftitle={Golf-Ball-Project},
            pdfauthor={Abhay Kulkarni},
            pdfborder={0 0 0},
            breaklinks=true}
...
contained in the data set ``Golf''. Prepare a Managerial Report 1.
Formulate and present the rationale for a hypothesis test that par could
...
between the means of the two population? 5. Do you see a need for larger
sample sizes and more testing with the golf balls? Discuss."
